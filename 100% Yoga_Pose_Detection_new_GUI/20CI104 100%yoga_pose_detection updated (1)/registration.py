...
image2 =Image.open('WhatsApp Image 2.jpeg')
image2 =image2.resize((740,740), Image.ANTIALIAS)
...
frame.place(x=127, y=88)



lbl = tk.Label(window, text="Register your account", font=('times', 20,' bold '), height=1, width=18,bg="blue",fg="white")
lbl.place(x=169, y=35)
