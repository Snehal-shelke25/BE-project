...
image2 = Image.open('WhatsApp Image 4.jpeg')
image2 = image2.resize((720,740), Image.ANTIALIAS)
...
Login_frame.place(x=775,y=194)
        
logolbl=tk.Label(Login_frame,bd=0, image=bg_icon).grid(row=0,columnspan=2,pady=20)
...
btn_log=tk.Button(Login_frame,text="Login",command=login,width=15,font=("Times new roman", 14, "bold"),bg="Green",fg="black", bd=3)
btn_log.grid(row=3,column=1,pady=10)
btn_reg=tk.Button(Login_frame,text="Create Account",command=registration,width=15,font=("Times new roman", 14, "bold"),bg="red",fg="black", bd=3)
